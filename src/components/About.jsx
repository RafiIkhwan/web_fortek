...
const About = () => {
  return (
    <div id="about" className="max-w-full mx-auto bg-white rounded-3xl z-[3] relative -top-5 h-[calc(100vh)]">
      <div className="w-full text-center py-6">
        <h2 className="font-poppins text-xl font-bold">Tentang Kami</h2>
      </div>
      <div className="items-center">
        <div className="overflow-x-auto space-x-4 flex flex-row bg-black h-full w-full snap-x">
          <Carousel>
